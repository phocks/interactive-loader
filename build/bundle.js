(function (global, factory) {
	...
	(global = global || self, global.base36Interactives = factory());
	...
	var alternatingCaseToObject = function(string, options) {
	...
	const base36Interactives = () => {
	  ...
	  const decoded = decode(alternatingCaseToObject(encodedHashElement.getAttribute("name")).encoded);
